<template>
  <q-page class="flex flex-center">
    <q-card class="q-ma-sm" v-for="item in data_playgroundsList" :key="item.id">
...
export default defineComponent({
  ...
  methods: {
      ...
      if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition((pos) => {
          ...
          let options = {
            headers: {
              "x-access-token":
                "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InJhZGVnMDA3QGdtYWlsLmNvbSIsImlkIjo4ODUsIm5hbWUiOm51bGwsInN1cm5hbWUiOm51bGwsImlhdCI6MTYyOTcwMDU3NSwiZXhwIjoxMTYyOTcwMDU3NSwiaXNzIjoiZ29sZW1pbyIsImp0aSI6ImVlNTI5ZDZmLTFmMDEtNGY5Mi1hN2U0LTIyY2E4OTAxMGM5NyJ9.ipb8SB59mWX_-HCS5Xh1I6Fmi8rypz7XV2a90uiWyM0",
            },
            params: { latlng: currentCoordinates, limit: "10" },
          };

          axios
            .get("https://api.golemio.cz/v2/playgrounds/", options)
            .then((res) => {
    ...
    getDestination(lat1, lon1, lat2, lon2) {
